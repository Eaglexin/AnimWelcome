...
public class PrivateMessageLauncherFragment extends LauncherBaseFragment{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
		...
		ivLikeVideo= rooView.findViewById(R.id.iv_private_message_like_video);
		ivThinkReward=rooView.findViewById(R.id.iv_private_message_think_reward);
		ivWatchMovie= rooView.findViewById(R.id.iv_private_message_watch_movie);
		ivThisWeek= rooView.findViewById(R.id.private_message_this_week);
		return rooView;
	}
    @Override
